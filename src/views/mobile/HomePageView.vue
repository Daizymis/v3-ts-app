<template>
  ...
  <van-tabs v-model:active="activeTab">
    <van-tab v-for="item in dataList.tabBarList" :key="item.id" :title="item.title" :name="item.name"></van-tab>
  </van-tabs>
</template>
...
import fieldSelect from '@/components/mobile/field-select/index';
