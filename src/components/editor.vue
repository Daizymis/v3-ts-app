...
export default {
  ...
  setup(props, context) {
    const init = {
      language_url: "/resource/editor/langs/zh_CN.js", //引入语言包文件
      language: "zh_CN", //语言类型

      skin_url: "/resource/editor/skins/ui/oxide", //皮肤：浅色
      // skin_url: '/tinymce/skins/ui/oxide-dark',//皮肤：暗色

      plugins: props.plugins, //插件配置
      toolbar: props.toolbar, //工具栏配置，设为false则隐藏
      toolbar_mode: "sliding",
      menubar: props.menubar, //菜单栏配置，设为false则隐藏，不配置则默认显示全部菜单，也可自定义配置--查看 http://tinymce.ax-z.cn/configure/editor-appearance.php --搜索“自定义菜单”
      menu: {
